...
def deploy() -> None:
    from smart_contracts.artifacts.experiment_audit.experiment_audit_client import (
        HelloArgs,
        ExperimentAuditFactory,
    )
    ...
    factory = algorand.client.get_typed_app_factory(
        ExperimentAuditFactory, default_sender=deployer_.address
    )
